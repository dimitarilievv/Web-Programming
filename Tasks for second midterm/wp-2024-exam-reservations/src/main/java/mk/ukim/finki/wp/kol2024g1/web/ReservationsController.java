...
public class ReservationsController {
    ...
    public String listAll(@RequestParam(required = false) String guestName,
        ...
        model.addAttribute("roomTypes", Arrays.asList(RoomType.values()));
...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    /**
     * This method should display the "form.html" template.
     * However, in this case, all 'input' elements should be filled with the appropriate value
     * for the reservations that is updated.
...
//    @PreAuthorize("hasRole('ADMIN')")
    public String showEdit(@PathVariable Long id,Model model) {
        if (this.reservationService.findById(id)!=null) {
        ...
        return "redirect:/reservations?error=ReservationNotFound";
